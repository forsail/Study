...
public class PreLollipopAnimatorDetailActivity extends AppCompatActivity {

    public static final String EXTRA_IMAGE = PreLollipopAnimatorDetailActivity.class.getSimpleName() + ".IMAGE";
